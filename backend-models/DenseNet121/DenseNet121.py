...
print('The model DenseNet121 loaded')
...
@application.route('/DenseNet121')
@cross_origin(supports_credentials=True)
def index():
 return "DenseNet121 Model"

@application.route('/DenseNet121/predict', methods=['POST'])
@cross_origin(supports_credentials=True)
def upload():
...
if __name__ == '__main__':
	...
	application.run(host='127.0.0.1', port=64000)